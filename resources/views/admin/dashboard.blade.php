    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="text-gray-500 dark:text-gray-400 text-sm">Total Celebrants</h3>
                    <p class="text-2xl font-semibold text-gray-700 dark:text-gray-200">{{ $totalCelebrants ?? 0}}</p>
                </div>
            </div>
        </div>
