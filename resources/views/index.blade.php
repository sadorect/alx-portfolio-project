            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
							<a href="#">
								<img class="header-logo-image" src="{{asset('frontend/dist/images/logo.svg')}}" alt="Logo">
                            </a>
                        </h1>
                    </div>
                </div>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Anniversary Record Keeper</h1>
	                        <p class="hero-paragraph">Your technology tool to keep your memory fresh in the hearts of your loved ones forever!</p>
